  ...
  return (
    <div className="max-w-5xl mx-auto space-y-5 animate-fade-in">
      ...
      <PageInfoModal 
        ...
        title="Tasks Page Guide"
        section="tasks"
        steps={[
          "Task Overview: See your most urgent pending or overdue tasks at a glance.",
          "Scheduling: Create, modify, and track standard operation procedures for pigs and pens.",
          "Checklists: Detailed sub-tasks generated for complex farm routines (e.g., Farrowing assistance).",
          "Automations: Review tasks automatically generated by the AI Farrowing Engine or camera logic."
        ]}
      />
    </div>
  );
